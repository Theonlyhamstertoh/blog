...
The other day, as we were leaving our office, Bobby asked me whether he should continue pursuing Pear, his startup, or focus on applying for internships. Looking back, I wish I could have given him more hope. Regardless of the path he chooses, from that day to next summer, he will excel. Even if everything doesn't go as planned, we are only 18, and his experiences in building Pear's MVP, cold emailing teachers, meeting with board members, and demonstrating the product will remain valuable in his knowledge toolbox.

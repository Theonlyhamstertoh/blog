...
draft: false
summary: 'What if you were intentional with your education? What if instead of passive education where others are teaching you, you switched to a more intentional education with you reaching out with questions instead? With you reading articles/books/audiobooks that no one has told you to do?'
authors: ['default']
---

# Intentional Education vs Passive Education
...
<cite className="bg-gray-200 p-2">Theodore Roosevelt, The Man in the Arena</cite>
